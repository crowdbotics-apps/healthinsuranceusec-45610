"""
Django settings for healthinsuranceusec_45610 project.
...
ROOT_URLCONF = 'healthinsuranceusec_45610.urls'
...
WSGI_APPLICATION = 'healthinsuranceusec_45610.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthinsuranceusec_45610 API",
    "DESCRIPTION": "API documentation for healthinsuranceusec_45610 App",
    "VERSION": "v1",
}
